...
<body>
                        ...
                        <div class="card">
                            <div class="card-header bg-white border-0 pt-4 pb-3">
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    if ($equipment['status'] === 'CHECK_OUT') $statusClass = 'status-checked-out';
                                    ...
                                    <span class="status-badge <?php echo $statusClass; ?>">
                                        <i class="bi bi-circle-fill me-1"></i><?php echo htmlspecialchars($equipment['status']); ?>
                                    </span>
                                </div>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-success" onclick="updateStatus('CHECK_IN')">
                                        <i class="bi bi-check-circle me-2"></i>Check In
                                    </button>
                                    <button class="btn btn-primary" onclick="updateStatus('CHECK_OUT')">
                                        <i class="bi bi-arrow-right-circle me-2"></i>Check Out
                                    </button>
    ...
    <script>
        ...
        function updateStatus(status) {
            ...
            if (!user || !user.trim()) {
                showAlert('User name is required to update equipment status.', 'warning');
                return;
            }
            ...
            var buttonText = '';
            switch(status) {
                case 'CHECK_IN': buttonText = 'Checking In...'; break;
                case 'CHECK_OUT': buttonText = 'Checking Out...'; break;
